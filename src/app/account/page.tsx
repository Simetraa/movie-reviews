...
export default function AccountPage() {
    ...
    } = useSWR<PaginatedResponse<Movie>>(
    ...
    return (
        <>
            ...
            <div className="flex flex-row gap-4 overflow-x-scroll overflow-y-clip">
                ...
                <Link href="/watchlist">
                    <div
                        className="flex w-[150px] h-[321px] flex-col items-center justify-center shadow-md rounded-md overflow-hidden bg-gray-100 hover:bg-gray-200 transition-all cursor-pointer">
