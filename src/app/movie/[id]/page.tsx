...
export default function MoviePage() {
    ...
    useEffect(() => {
        if (
            ...
            console.log("Rated value:", accountStatesData.rated.value);
        }
    }, [accountStatesData]);
            ...
            <div className="flex gap-8">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-8 flex-row">
                        <button className="bg-red-700 flex self-start p-2 gap-1 items-center justify-center text-white rounded-sm">
